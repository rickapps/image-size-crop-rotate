...
Section "MainSection" SEC01
  ...
  File "..\ImagesForArm\powered_by_dr.gif"
  File "..\ImagesForArm\money_back_g.gif"
  File "..\ImagesForArm\exit.gif"
  File "..\ImagesForArm\continue_free_trial.gif"
  File "..\ImagesForArm\buy.gif"
  File "..\ImagesForArm\security_lock_text.gif"
  File "..\ImagesForArm\Logo.jpg"
SectionEnd
...
Section Uninstall
  ...
  Delete "$INSTDIR\Images\security_lock_text.gif"
  Delete "$INSTDIR\Images\buy.gif"
  Delete "$INSTDIR\Images\continue_free_trial.gif"
  Delete "$INSTDIR\Images\exit.gif"
  Delete "$INSTDIR\Images\money_back_g.gif"
  Delete "$INSTDIR\Images\powered_by_dr.gif"
